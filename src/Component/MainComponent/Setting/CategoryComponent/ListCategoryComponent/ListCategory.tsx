...
const ListCategory = (props: any) => {
  ...
  const handleRestore = async (pid: string) => {
    props.setLoading(true);
    try {
      let response = await RestoreCategoryFuncation(pid);
      setId("");
      if (response.Success) {
        CallCheckuser();
        toast.success(response.Message, {
  ...
  const Restore = (cid: string) => {
    confirmAlert({
      ...
      buttons: [
        {
          label: "Yes",
          onClick: async () => await handleRestore(cid),
        },
        {
          label: "No",
        },
  ...
  const handleActive = async (lid: string) => {
    props.setLoading(true);
    try {
      let response = await ActivetedCategoryFuncation(lid);
      setId("");
      if (response.Success) {
        CallCheckuser();
        toast.success(response.Message, {
  ...
  const Activetated = (cid: string) => {
    confirmAlert({
      title: "Confirm to Activate Record!",
      message: "Are you sure to do this.",
      buttons: [
        {
          label: "Yes",
  ...
  const DeActivated = (cid: string) => {
    confirmAlert({
      title: "Confirm to Deactivate Record!",
      message: "Are you sure to do this.",
      buttons: [
        {
          label: "Yes",
          onClick: async () => await handleDeActive(cid),
        },
        {
          label: "No",
        },
  ...
  const handleDeActive = async (lid: string) => {
    props.setLoading(true);
    try {
      let response = await DeActivetedCategoryFuncation(lid);
      setId("");
      if (response.Success) {
        CallCheckuser();
        toast.success(response.Message, {
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li>
                        <button
                          ...
                          onClick={() => Activetated(category.id)}
                          style={{
                            display: category.isDeleted
                              ? "none"
                              : !category.isActive
                      ...
                      <li>
                        <button
                          ...
                          onClick={() => DeActivated(category.id)}
                          style={{
                            display: category.isDeleted
                              ? "none"
                              : category.isActive
